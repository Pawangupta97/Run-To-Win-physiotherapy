            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold text-slate-700 pt-2">
                ...
                <div className="flex items-start space-x-2 bg-slate-50 p-3 rounded-xl border border-slate-100">
                  ...
                  <div>
                    <span className="block font-bold text-slate-900">10, Manish Investment</span>
                    <span className="text-[11px] text-slate-500">Datta Mandir Marg, Sewri, Mumbai 400015</span>
                  </div>
                </div>
                <div className="flex items-center space-x-2 bg-slate-50 p-3 rounded-xl border border-slate-100">
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-3">
                ...
                <a
                  ...
                  className="flex-1 bg-slate-100 text-slate-800 py-3 rounded-xl text-xs font-bold hover:bg-slate-200 transition text-center flex items-center justify-center space-x-1.5"
                >
